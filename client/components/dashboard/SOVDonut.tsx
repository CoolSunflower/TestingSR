...
const data = [
  { name: "Company A", value: 45, color: "#3B82F6" },
  { name: "Company B", value: 30, color: "#F4B400" },
  { name: "Company C", value: 25, color: "#EF4444" },
]
...
export default function SOVDonut() {
  ...
  const [activeName, setActiveName] = useState("Company A");
          ...
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie
                ...
                onMouseLeave={() => setActiveName("Company A")}
                cursor="pointer"
              >
